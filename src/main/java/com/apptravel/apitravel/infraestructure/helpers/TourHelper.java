...
import com.apptravel.apitravel.domain.entities.jpa.*;
...
import com.apptravel.apitravel.infraestructure.services.ReservationService;
import com.apptravel.apitravel.infraestructure.services.TicketService;
    ...
    public Set<TicketEntity> createTickets(Set<FlyEntity> flights, CustomerEntity customer) {
        ...
        flights.forEach( fly -> {
            var ticketToPersist = TicketEntity
                    ...
                    .fly(fly)
                    .customer(customer)
                    .price(fly.getPrice().add(fly.getPrice().multiply(TicketService.changer_price_percentage)))
    ...
    public Set<ReservationEntity> createReservations(HashMap<HotelEntity, Integer> hotels, CustomerEntity customer) {
        ...
        hotels.forEach((hotel, totalDays) -> {
            var reservationToPersist = ReservationEntity.
                    ...
                    .price(hotel.getPrice().add(hotel.getPrice().multiply(ReservationService.charges_price_percentages)))
                    .build();

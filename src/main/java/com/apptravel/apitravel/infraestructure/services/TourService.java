...
import com.apptravel.apitravel.domain.repositories.jpa.TourRepository;
...
import com.apptravel.apitravel.infraestructure.helpers.TourHelper;
...
public class TourService implements ITourService {
    ...
    public void removeReservation(Long tourId, UUID reservationId) {
        var tourUpdate = this.tourRepository.findById(tourId).orElseThrow(() -> new IdNotFoundException(Tables.hotel.name()));

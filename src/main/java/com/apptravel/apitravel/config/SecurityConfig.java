...
public class SecurityConfig {
    ...
    public SecurityConfig( @Qualifier( value = "appUserServices" ) UserDetailsService userDetailsService ) {
    ...
    private static final String APPLICATION_OWNER = "App Travel";
    ...
    public SecurityFilterChain securityFilterChain( HttpSecurity http ) throws Exception {
        ...
        http.exceptionHandling( ex -> ex.authenticationEntryPoint( new LoginUrlAuthenticationEntryPoint( LOGIN_RESOURCE )));
    ...
    @Bean
    public AuthenticationProvider authenticationProvider(BCryptPasswordEncoder encode ) {
